#ifndef MAESTRO_EMULATOR_H_
#define MAESTRO_EMULATOR_H_

#include <rclcpp/rclcpp.hpp>
#include "robosub/utility/serial.hpp"
#include <string>
#include <map>
 ...
 */
class MaestroEmulator : public rclcpp::Node
{
    /*
...
private:
     ...
     * thruster.
     */
    std::map<string, rclcpp::Time> _thruster_timeouts;

    /*
     * A hashmap of the next thruster autokill timeouts indexed by the name of
     * the thruster.
     */
    std::map<string, rclcpp::Time> _autokill_timeouts;
